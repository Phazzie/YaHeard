import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop, a as safe_not_equal } from './chunks/ssr-ChTcx7Me.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <link rel="icon" href="' + assets2 + '/favicon.png" />\n    <meta name="viewport" content="width=device-width, initial-scale=1" />\n    <title>YaHeard · Multi-AI Transcription Consensus</title>\n    ' + head + '\n  </head>\n  <body data-sveltekit-preload-data="hover">\n    <div class="sveltekit-body-container">' + body + "</div>\n  </body>\n</html>",
...
async function respond(request, options2, manifest, state) {
  ...
  try {
    if (route) {
      ...
      if (BROWSER && state.before_handle) ;
    }
